...
//vi tri cac khoi trong tro choi
...
{
    bool ret = BaseObject::LoadImageFile(path, screen);  //tai hinh anh Khoi
    return ret;
}
...
void BlockObject::DoRun(UINT& x_val) //di chuyen khoi sang trai
{
    this->rect_.x += x_val;
...
bool DoubleBlock::InitBlock(SDL_Renderer* screen , const int& xp)
{
    ...
    bool ret1 = m_Topblock.LoadImg("img//topblock2.bmp", screen);
    bool ret2 = m_BottomBlock.LoadImg("img//bottomblock2.bmp", screen);
...
//moving blocks and check collisions with player object
